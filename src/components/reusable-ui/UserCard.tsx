...
export default function UserCard({ href, name, job, link }: UserCardProps): JSX.Element {
    return(
        <a href={link} className="group basis-[23rem] md:basis-[25rem] relative h-auto my-1 w-auto aspect-[159/182] px-0 md:mx-[0.5rem] overflow-hidden">
